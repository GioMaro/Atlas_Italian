...
`docker-compose.yml`. The compose file builds the backend and frontend images from the local source so the Italian
translations are available out of the box. Now run
